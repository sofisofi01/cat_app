...
urlpatterns = [
    ...
    path(
        "like-prediction/<int:prediction_id>/",
        views.like_prediction,
        name="like_prediction",
    ),
    ...
    path(
        "comments/<int:prediction_id>/",
        views.get_comments_for_prediction,
        name="get_comments_for_prediction",
    ),
]
